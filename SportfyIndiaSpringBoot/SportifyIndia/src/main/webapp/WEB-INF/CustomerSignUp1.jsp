                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block" style="padding-left: 550px;">
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link active dropdown-toggle" data-toggle="dropdown"><i class='far fa-user-circle' style="font-size: 20px;"></i></a>
                                <!-- <div class="dropdown-menu position-absolute rounded-0 border-0 m-0">
                                    <a href="" class="dropdown-item">Sign In</a>
                                    <a href="" class="dropdown-item">Sign Up</a>
                                </div> -->
                ...
                <form action="/signup" method="post">
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input id="name" name="name" class="form-control" placeholder="Your Full Name">
                        </div>
                       <div class="form-group col">
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input id="mobno" name="mobno" class="form-control" pattern="[1-9]{10}" placeholder="Mobile No">
                        </div>
                        <div class="form-group col">
                            <label for="username">User Name<i style="color: red;">*</i></label>
                            <input id="username" name="uname" class="form-control" placeholder="User Name">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col">
                        ...
                        <div class="form-group col">
                            ...
                            <textarea id="adress" name="address" class="form-control" placeholder="Adress"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col">
                            <label for="pincode">Pincode<i style="color: red;">*</i></label>
                            <input id="pincode" name="pincode" class="form-control" pattern="[0-9]{6}" placeholder="Pincode">
                        </div>
                        <div class="form-group col">
