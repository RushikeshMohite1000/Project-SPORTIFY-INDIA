        ...
        <div class="row px-xl-5">
            <div class="col-lg-12 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <%List<Order> ords=(List<Order>)request.getAttribute("orders"); 
                    
                    	for(Order o:ords){%>
                        <tr>
                            <td class="align-middle"><%=o.getProduct().getProdName() %></td>
                            <td class="align-middle"><%=o.getDate() %></td>
                            <td class="align-middle"><%=o.getProduct().getProdPrice() %></td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <input type="text" name="quantity" class="form-control form-control-sm bg-secondary border-0 text-center" value=<%=o.getQuantity() %> readonly>
                                </div>
                            </td>
                            <td class="align-middle"><%=o.getTotalCost() %></td>
                            <td class="align-middle"><%=o.getShippingAddress() %></td>
                            <td class="align-middle"><%=o.getPaymentBy() %></td>
                            <td class="align-middle"> <div class="input-group quantity mx-auto" style="width: 100px;">
                                <input type="text" class="form-control form-control-sm bg-secondary border-0 text-center" value="<%=o.getStatus() %>" readonly>
                            </div></td>
                            <td class="align-middle"><a href="/upateorder?id=<%=o.getOrderId() %>" class="btn btn-sm btn-primary">Update</a></td>
                            <td class="align-middle"><a href="/deleteorder?id=<%=o.getOrderId() %>" class="btn btn-sm btn-danger">Delete</a></td>
                        </tr>
                        <%} %>
                    </tbody>
                </table>
