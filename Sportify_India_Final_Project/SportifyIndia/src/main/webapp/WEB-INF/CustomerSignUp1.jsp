                ...
                <form action="/signup" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            ...
                            <textarea id="adress" name="address" class="form-control"required placeholder="Adress"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col">
                            <label for="pincode">Pincode<i style="color: red;">*</i></label>
                            <input id="pincode" name="pincode" class="form-control" required pattern="[0-9]{6}" placeholder="Pincode">
                        </div>
                        <div class="form-group col">
