                        ...
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="/shopCricketItem">Shop Now With Coupon</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="product-offer mb-30" style="height: 200px;">
                    ...
                    <div class="offer-text">
                        ...
                        <a href="/getproddisc30" class="btn btn-primary">Shop Now</a>
                    </div>
                </div>
                <div class="product-offer mb-30" style="height: 200px;">
                    ...
                    <div class="offer-text">
                        ...
                        <a href="/getproddisc40" class="btn btn-primary">Shop Now</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="/procategory?id=<%=c.getCategoryId()%>">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src=<%=c.getCategoryImage() %> alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6><%=c.getCatrgoryName()%></h6>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src=<%=p.getProductImages().get(1).getProdImageImage()%> alt="">
                        <div class="product-action">
                        </div>
                    </div>
                    <div class="text-center py-4">
                        <a class="h6 text-decoration-none text-truncate" href=""><%=p.getProdName() %></a>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5>&#8377;<%=p.getProdPrice()*(p.getProdDiscount()*0.01)%></h5><h6 class="text-muted ml-2"><del>&#8377;<%=p.getProdPrice() %></del></h6>
                        </div>
                    </div>
                </div>
                <div>
                    <a href="/prodetails?id=<%=p.getProdId()%>" class="btn btn-primary">Details</a><%if(sess.getAttribute("customer")!=null) {%><a href="/addtocart?id=<%=p.getProdId()%>&quantity=1" class="btn btn-primary" style="margin: 10px;">Add To Cart</a><%}else{%><a href="/index" class="btn btn-primary" style="margin: 10px;">Add To Cart</a><%} %>
                </div>
                <br>
            </div>
            <%}
