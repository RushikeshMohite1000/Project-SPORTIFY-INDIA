...
public class ProductImage 
{
	...
	public ProductImage( String prodImageImage, Product product) {
	...
	public String getProdImageImage() {
		return prodImageImage;
	}

	public void setProdImageImage(String prodImageImage) {
		this.prodImageImage = prodImageImage;
	}
